...
Same as dataloaders.py except latlons is (H, W, 2) per-pixel instead of (2,) tile centroid.
"""
...
class CycleDatasetPixelLatLon(Dataset):
    """Same as CycleDataset but returns per-pixel latlons (H, W, 2)."""
