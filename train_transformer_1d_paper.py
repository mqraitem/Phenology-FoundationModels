...
def main():
	...
	parser.add_argument("--all_pixels", type=str2bool, default=True,
					   help="Train on all pixels (kept for backward compat)")
	...
	train_dataloader = DataLoader(
		cycle_dataset_train, batch_size=args.batch_size,
		shuffle=True, num_workers=4, pin_memory=True, drop_last=True,
	)
	val_dataloader = DataLoader(
		cycle_dataset_val, batch_size=1, shuffle=False, num_workers=0,
	)
	test_dataloader = DataLoader(
		cycle_dataset_test, batch_size=1, shuffle=False, num_workers=0,
	)
