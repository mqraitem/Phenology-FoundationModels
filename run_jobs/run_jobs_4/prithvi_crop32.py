"""Submit jobs for Prithvi Single-Scale Conv3d crop32 with raw input concat (4 months)."""
import os
import sys
...
model_configs = [
    ("tiny",  "tiny_crop32"),    # 12 blocks
    ("100m",  "100m_crop32"),    # 12 blocks
    ("300m",  "300m_crop32"),    # 24 blocks
]

wandb_project = get_wandb_project(data_percentage, months_str)

for model_size, group_suffix in model_configs:
    group_name = f"prithvi_final_{group_suffix}"
