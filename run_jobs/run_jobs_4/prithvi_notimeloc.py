"""Submit jobs for Prithvi 100M crop32 without time/location, with input concatenation and pretraining (4 months)."""
import os
import sys
...
group_name = "prithvi_final_100m_crop32_notimeloc"
