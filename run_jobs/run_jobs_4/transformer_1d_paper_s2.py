"""Submit jobs for paper-matched 1D Transformer on S2 data (4 months)."""
import os
import sys
...
for seed in seeds:
    for learning_rate in learning_rates:
        ...
        command = (f"qsub -v args='"
                   ...
                   f" run_jobs/sge_scripts/train_transformer_1d_paper_s2.sh")
        print(command)
