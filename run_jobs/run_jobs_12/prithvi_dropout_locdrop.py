"""Submit Prithvi runs with dropout + location dropping (100M, crop32, 12 months)."""
import os
import sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))
from run_jobs_12.common import is_done, setup_records_dir, get_wandb_project
...
batch_size = 72  # best from prithvi_final_100m_crop32 best_params.csv (12 months)
p_loc_drops = [0.1, 0.2]
dropouts = [0.05, 0.1]
seeds = [42, 123, 456]
